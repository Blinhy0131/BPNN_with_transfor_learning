...
# 將新建立的模型權重替換成匯入的模型權重
model.layers[2].set_weights(trained_model.layers[2].get_weights())
model.layers[3].set_weights(trained_model.layers[3].get_weights())
model.layers[4].set_weights(trained_model.layers[4].get_weights())
...
input("Please press the Enter key to countine")
